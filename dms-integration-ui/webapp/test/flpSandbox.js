		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DMS Integration Option UI",
									"targetURL": "#comnttdmsintegrationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdmsintegrationui-display": {
								"semanticObject": "comnttdmsintegrationui",
								"action": "display",
								"description": "DMS Integration Option UI",
								"title": "DMS Integration Option UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.dmsintegrationui",
									"url": sap.ui.require.toUrl("com/ntt/dmsintegrationui")
								}
							}
						}
					}
